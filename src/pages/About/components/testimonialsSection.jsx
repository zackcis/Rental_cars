...
import her from '../../../assets/img/k.png'
    ...
    return (
        <div className="mx-20 flex flex-col gap-5">
            ...
            <div className="flex justify-between items-center py-20">
                <div className="bg-[#f9f9f9] w-[30%]  flex flex-col  items-start rounded-3xl">
                    ...
                    <p className="text-center p-10 py-16 mb-6">
                    ...
                    <div className="w-[100%] bg-[#5937e0] p-9 py-14 rounded-b-3xl relative">
                        <div className="flex flex-col items-center justify-center absolute bottom-6 right-28">
