            ...
            <div className="flex max-[430px]:flex-col  gap-8 justify-center items-center">
                ...
                <div className='z-10 lg:w-[40%] flex justify-center items-center '>
                    <div className=' p-10 lg:w-[80%]  rounded-2xl flex flex-col justify-center items-center gap-6 bg-[#5937e0]'>
                        ...
                        <div onClick={toggleDropdown} className='bg-[#694be3] w-[100%] p-1 flex justify-between items-center relative rounded-lg text-white'>
                        ...
                        <div className={`z-10  bg-[#f9f8f8] flex flex-col absolute -bottom-11 rounded-lg w-[25%]  ${!dropdownVisible ? 'hidden' : null}`}>
                            {carsType.map((element, index) => (
                                <p key={index} onClick={() => selectitem(element)} className='rounded-lg p-2 hover:bg-[#5937e0] hover:text-white'>
                                    {element}
                                </p>
                            ))}
                        ...
                        <div onClick={toggleDropdown2} className='bg-[#694be3] text-white w-[100%] p-1 rounded-lg flex justify-between items-center relative'>
                        ...
                        <div className={`z-10  bg-[#f9f8f8] flex flex-col  absolute -bottom-6 rounded-lg w-[25%]  ${!dropdownVisible2 ? 'hidden' : null}`}>
                            {places.map((element, index) => (
                                <p onClick={() => selectitem2(element)} key={index} className='rounded-lg p-2 hover:bg-[#5937e0] hover:text-white'>{element}</p>
                            ))}
                        </div>
                        <div onClick={toggleDropdown3} className='bg-[#694be3] text-white w-[100%]  p-1 rounded-lg flex justify-between items-center relative '>
                        ...
                        <div className={`z-10  bg-[#f9f8f8] flex flex-col  absolute -bottom-20 rounded-lg w-[25%] ${!dropdownVisible3 ? 'hidden' : null}`}>
                            {places.map((element, index) => (
                                <p onClick={() => selectitem3(element)} key={index} className='rounded-lg p-2 hover:bg-[#5937e0] hover:text-white'>{element}</p>
                            ))}
                        </div>
